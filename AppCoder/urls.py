...
urlpatterns = [
    ...
    path('curso/<pk>', CursoDetalle.as_view(), name='curso-detalle'),
    path('curso/borrar/<pk>', CursoDelete.as_view(), name='curso-borrar'),
    path('curso/editar/<pk>', CursoUpdate.as_view(), name='curso-editar'),

    path('profesor/<pk>', ProfesorDetalle.as_view(), name='profesor-detalle'),
